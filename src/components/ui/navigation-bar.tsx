...
export default function NavigationBar() {
  ...
  const founderNavItems = [
    ...
    { href: '/deal-rooms', label: 'Deal Rooms', icon: <Handshake className="h-4 w-4 mr-2" /> },
    { href: '/analytics/dashboard', label: 'Analytics', icon: <BarChart2 className="h-4 w-4 mr-2" /> },
  ...
  const investorNavItems = [
    { href: '/dashboard', label: 'Dashboard', icon: <LayoutDashboard className="h-4 w-4 mr-2" /> },
    { href: '/deal-rooms', label: 'Deal Rooms', icon: <Handshake className="h-4 w-4 mr-2" /> },
    { href: '/investor/portfolio', label: 'Portfolio', icon: <Briefcase className="h-4 w-4 mr-2" /> },
    { href: '/analytics/dashboard', label: 'Analytics', icon: <BarChart2 className="h-4 w-4 mr-2" /> },
    { href: '/messages', label: 'Messages', icon: <MessageSquare className="h-4 w-4 mr-2" /> },
    { href: '/investor/insights', label: 'Insights', icon: <FileText className="h-4 w-4 mr-2" /> },
    { href: '/subscription', label: 'Subscription', icon: <CreditCard className="h-4 w-4 mr-2" /> },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex flex-1 items-center">
            <Link href="/dashboard" className="flex items-center text-blue-600 font-bold text-lg">
              <div className="mr-2 h-8 w-8 bg-blue-600 rounded flex items-center justify-center text-white">VH</div>
              VentureHive
            </Link>
