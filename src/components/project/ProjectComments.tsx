...
import CommentModerator from '@/components/moderation/CommentModerator';
...
export default function ProjectComments({ comments, onAddComment }: ProjectCommentsProps) {
  ...
  const CommentItem = ({ comment, depth = 0 }: { comment: Comment; depth?: number }) => (
    <div 
      className={`mb-6 ${depth > 0 ? 'ml-8 border-l-2 border-gray-100 pl-6' : ''}`}
    >
            ...
            <div className="mb-2">
              ...
              {moderationResult && moderationResult.isFlagged && (
                <div className="mt-2 p-3 bg-red-50 text-red-700 rounded-md text-sm">
                  <p className="font-medium">Your comment may violate our community guidelines:</p>
