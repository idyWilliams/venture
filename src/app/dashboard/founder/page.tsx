...
import EngagementStats from "@/src/components/engagement/EngagementStats";
...
const mockProjects = [
  {
    ...
    description:
      "A mobile app that uses artificial intelligence to provide personalized healthcare recommendations and monitoring.",
    industry: "Healthcare",
    fundingStage: "Seed",
      ...
      recentViewers: [
        {
          ...
          viewedAt: "2023-06-01T14:30:00.000Z",
        },
        {
          id: "inv2",
          name: "Andreessen Horowitz",
          viewedAt: "2023-05-29T10:15:00.000Z",
        },
        {
          id: "inv3",
          name: "Y Combinator",
          viewedAt: "2023-05-28T09:45:00.000Z",
        },
      ],
    },
  },
  {
    ...
    description:
      "A blockchain-based platform that tracks and verifies sustainability metrics across global supply chains.",
      ...
      recentViewers: [
        {
          id: "inv4",
          name: "Accel Partners",
          viewedAt: "2023-05-31T16:20:00.000Z",
        },
...
const mockNotifications = [
  {
    ...
    type: "view",
    content:
      "Sequoia Capital viewed your AI-Powered Healthcare Assistant project",
    isRead: false,
  ...
  },
  {
    ...
    type: "like",
    content:
      "Andreessen Horowitz liked your AI-Powered Healthcare Assistant project",
    isRead: true,
  ...
  },
  {
    ...
    type: "comment",
    content:
      "Y Combinator commented on your AI-Powered Healthcare Assistant project",
    isRead: false,
  ...
  },
  {
    ...
    content:
      "Accel Partners requested to contact you about your Sustainable Supply Chain Platform",
    isRead: false,
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Manage your projects and investor engagements
          </p>
        </div>
                ...
                <Card>
                  <CardContent className="flex flex-col items-center justify-center py-12">
                    ...
                    <p className="text-gray-500 text-center mb-4">
                      Create your first project to start connecting with
                      investors
                    </p>
                    <Link href="/projects/new">
              ...
              <div className="flex items-center justify-between">
                ...
                <div>
                  <Button
                    ...
                    className={
                      isContactable ? "bg-green-600 hover:bg-green-700" : ""
                    }
                  >
